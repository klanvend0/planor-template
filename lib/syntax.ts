...
const PYTHON_BUILTINS = new Set([
  'abs', 'bool', 'dict', 'enumerate', 'float', 'input', 'int', 'len', 'list', 'max', 'min',
  'print', 'range', 'round', 'sorted', 'str', 'sum', 'tuple', 'type', 'zip',
]);
...
const JS_BUILTINS = new Set([
  'Array', 'Boolean', 'console', 'Date', 'JSON', 'Math', 'Number', 'Object', 'String', 'parseInt',
  'parseFloat', 'isNaN', 'push', 'pop', 'map', 'filter', 'length', 'log', 'toFixed', 'join',
  'slice', 'split', 'includes',
]);
